...
<div class="card">
    <div class="card-header">
        <h3><?php echo translate('user_management'); ?></h3>
    </div>
    <div class="card-body">
        ...
        <div class="pagination">
            <?php if ($page > 1): ?>
                <a href="index.php?page=<?php echo $page - 1; ?>&search=<?php echo urlencode($search); ?>" class="btn btn-secondary"><?php echo translate('previous'); ?></a>
            <?php endif; ?>
            <?php if ($page < $total_pages): ?>
                <a href="index.php?page=<?php echo $page + 1; ?>&search=<?php echo urlencode($search); ?>" class="btn btn-secondary"><?php echo translate('next'); ?></a>
            <?php endif; ?>
        </div>
    </div>
</div>
